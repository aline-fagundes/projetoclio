CREATE TABLE tb_presenca (
  ...
  fk_id_usuario_presenca int NOT NULL,
  fk_id_museu_presenca int NOT NULL,
  PRIMARY KEY (id_presenca),
  KEY fk_id_usuario_presenca (fk_id_usuario_presenca),
  ...
  CONSTRAINT fk_id_usuario_presenca FOREIGN KEY (fk_id_usuario_presenca) REFERENCES tb_usuarios (id_usuario)
)