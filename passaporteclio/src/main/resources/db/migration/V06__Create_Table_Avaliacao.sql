CREATE TABLE tb_avaliacao (
  ...
  fk_id_pessoa_avaliacao int NOT NULL,
  fk_id_museu_avaliacao int NOT NULL,
  PRIMARY KEY (id_avaliacao),
  KEY fk_id_museu (fk_id_museu_avaliacao),
  KEY fk_id_usuario_avaliacao (fk_id_pessoa_avaliacao),
  CONSTRAINT fk_id_museu_avaliacao FOREIGN KEY (fk_id_museu_avaliacao) REFERENCES tb_museus (id_museu),
  CONSTRAINT fk_id_pessoa_avaliacao FOREIGN KEY (fk_id_pessoa_avaliacao) REFERENCES tb_pessoas (id_pessoa)
)